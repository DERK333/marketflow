...
export default function Browse() {
  ...
  }, [query, category, sort, delivery, condition, maxPrice]);
  ...
  const FilterPanel = () => (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-sm font-semibold text-foreground mb-3">Max Price: ${maxPrice.toLocaleString()}</h3>
        <Slider
          value={[maxPrice]}
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {activeFilters.length > 0 && (
        <div className="flex gap-2 mb-4 flex-wrap">
          ...
          <button onClick={() => { setCategory(''); setDelivery(''); setCondition(''); }}
